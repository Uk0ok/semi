...
--공지사항 첨부파일 테이블 생성
CREATE TABLE TB_ATTACHED_FILE_NT (
	FILE_NO NUMBER NOT NULL,
    QNA_NO NUMBER NOT NULL,
    USER_NO NUMBER NOT NULL,
	FILE_NAME VARCHAR2(255) NOT NULL,
	MFILE_NAME VARCHAR2(255) NOT NULL,
	CONSTRAINT PK_ATTACHED_NT PRIMARY KEY(FILE_NO),
	CONSTRAINT FK_ATTACHED_NT_ADMIN FOREIGN KEY(ADMIN_NO) REFERENCES TB_ADMIN(ADMIN_NO) ON DELETE CASCADE,
    CONSTRAINT FK_ATTACHED_NT FOREIGN KEY(NOTICE_NO) REFERENCES TB_NOTICE(NOTICE_NO) ON DELETE CASCADE
);
...
CREATE TABLE TB_QNA (
   ...
   CONSTRAINT FK_QNA_USER FOREIGN KEY (USER_NO) REFERENCES TB_USER(USER_NO) ON DELETE CASCADE
   CONSTRAINT FK_QNA_ADMIN FOREIGN KEY (ADMIN_NO) REFERENCES TB_ADMIN(ADMIN_NO) ON DELETE CASCADE
);
...
INSERT INTO TB_QNA (
	...
	SEQ_QNA.NEXTVAL, '회원가입 문의',  '문의사항 내용', '5', '1',  DEFAULT, DEFAULT,'답변내용',DEFAULT, DEFAULT, DEFAULT, DEFAULT);
INSERT INTO TB_QNA (
	QNA_NO, QNA_TITLE, QNA_CONTENT, USER_NO, ADMIN_NO, CREATE_DATE, HITS, ANSWER, MOD_YN, MOD_DATE, STATUS_YN, DELETE_YN
	) VALUES (
...
CREATE TABLE TB_ATTACHED_FILE_Q (
	...
	FILE_NAME VARCHAR2(255) NOT NULL,
	MFILE_NAME VARCHAR2(255) NOT NULL,
	CONSTRAINT PK_ATTACHED_Q PRIMARY KEY(FILE_NO),
	CONSTRAINT FK_ATTACHED_Q_USER FOREIGN KEY(USER_NO) REFERENCES TB_USER(USER_NO) ON DELETE CASCADE,
    CONSTRAINT FK_ATTACHED_Q FOREIGN KEY(QNA_NO) REFERENCES TB_QNA(QNA_NO) ON DELETE CASCADE
);
...
CREATE TABLE TB_REPORT (
   ...
   CONSTRAINT FK_TB_REPORT_USER FOREIGN KEY (USER_NO) REFERENCES TB_USER(USER_NO) ON DELETE CASCADE
   CONSTRAINT FK_TB_REPORT_ADMIN FOREIGN KEY (ADMIN_NO) REFERENCES TB_ADMIN(ADMIN_NO) ON DELETE CASCADE
);
...
CREATE TABLE TB_ATTACHED_FILE_RP (
	...
	CONSTRAINT FK_ATTACHED_RP_USER FOREIGN KEY(USER_NO) REFERENCES TB_USER(USER_NO) ON DELETE CASCADE,
    CONSTRAINT FK_ATTACHED_RP FOREIGN KEY(REPORT_NO) REFERENCES TB_REPORT(REPORT_NO) ON DELETE CASCADE
);
