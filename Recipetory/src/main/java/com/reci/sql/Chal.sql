...
CREATE TABLE TB_BOARD_CHALLENGE2(
	...
	MOD_YN	CHAR(1)	DEFAULT 'N' CHECK(MOD_YN IN('Y', 'N')),
	DEL_YN	CHAR(1)	DEFAULT 'N' CHECK(DEL_YN IN('Y', 'N')),
    CONSTRAINT PK_TB_BOARD_CHALLENGE2 PRIMARY KEY(POST_NO),
    CONSTRAINT FK_TB_BOARD_CHALLENGE2 FOREIGN KEY(USER_NO) REFERENCES TB_USER(USER_NO)
);
...
--챌린지 테이블에 데이터 넣어
INSERT INTO TB_BOARD_CHALLENGE VALUES(SEQ_CHA_PNO.NEXTVAL,001,'일주일 집밥 챌린지','일주일간 집밥 해먹기~ 집에서 밥먹기 아니구여 직접 해먹어야됩니다~ 배달ㄴㄴ',SYSDATE,SYSDATE+30,'100','50','/Recipetory/WebContent/img/challengeBoard/jipbab.jpg','N',NULL,'N');
INSERT INTO TB_BOARD_CHALLENGE VALUES(SEQ_CHA_PNO.NEXTVAL,002,'밀가루 끊기 챌린지','밀가루를 끊으면 피부개선, 다이어트, 소화불량 등에 효과가 있대요~',SYSDATE,SYSDATE+40,'90','30','/Recipetory/WebContent/img/challengeBoard/flour.jpg','N',NULL,'N');
INSERT INTO TB_BOARD_CHALLENGE VALUES(SEQ_CHA_PNO.NEXTVAL,003,'물 2L 마시기 챌린지','세계보건기구 WHO에서는 하루 약 2L 정도의 물을 섭위할 것을 권장하고 있습니다.',SYSDATE,SYSDATE+50,'80','20','/Recipetory/WebContent/img/challengeBoard/water.jpg','N',NULL,'N');
INSERT INTO TB_BOARD_CHALLENGE VALUES(SEQ_CHA_PNO.NEXTVAL,004,'아침먹기 챌린지','활발한 두뇌활동, 식사량 조절, 건강한 체중관리, 원할한 혈당조절을 원하신다면 아침을 먹어보아요~!',SYSDATE,SYSDATE+20,'70','10','/Recipetory/WebContent/img/challengeBoard/breakfast.jpg','N',NULL,'N');
